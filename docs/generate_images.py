...
plt.tight_layout()
plt.savefig("docs/lines_binary.png", bbox_inches="tight")
...
plt.tight_layout()
plt.savefig("docs/lines_length.png", bbox_inches="tight")
...
plt.tight_layout()
plt.savefig("docs/polygons_binary.png", bbox_inches="tight")
...
plt.tight_layout()
plt.savefig("docs/polygons_area.png", bbox_inches="tight")
